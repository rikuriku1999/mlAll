...
def NNclass():
    ...
    for i in poms:
        ...
        df_train2=df_train2.drop(["real_time","Vind","wind_dir","   __mag,_comp ","   __lat,__deg ","   __lon,__deg "], axis=1)
        df_test2=df_test2.drop(["real_time","Vind","wind_dir","   __mag,_comp ","   __lat,__deg ","   __lon,__deg "], axis=1)
        ...
        clf = GridSearchCV(estimator=MLPClassifier(random_state=0),param_grid=search_params, scoring="f1_macro" , cv=5,verbose=10,n_jobs=-1) 
...
def RDFclass():
    ...
    for i in poms:
        ...
        #使わない列を削除
        df_train2=train_dataset.drop(["real_time","Vind","wind_dir","   __mag,_comp ","   __lat,__deg ","   __lon,__deg "], axis=1)
        df_test2=test_dataset.drop(["real_time","Vind","wind_dir","   __mag,_comp ","   __lat,__deg ","   __lon,__deg "], axis=1)

...
def NNclass():
    ...
    four_test = df_list_test[df_list_test['workload'] == 4]
    three_test = df_list_test[df_list_test['workload'] == 3]
    two_test = df_list_test[df_list_test['workload'] == 2]
    one_test = df_list_test[df_list_test['workload'] == 1]

    five_train = df_list_train[df_list_train['workload'] == 5]
    four_train = df_list_train[df_list_train['workload'] == 4]
    three_train = df_list_train[df_list_train['workload'] == 3]
    two_train = df_list_train[df_list_train['workload'] == 2]
    one_train = df_list_train[df_list_train['workload'] == 1]
    ...
    one_test,three_test = sm.fit_resample(one_test,three_test)
    ...
    df_train_modified = df_list_train
    df_test_modified = df_list_test
    ...
    for i in poms:
        ...
        train_x = df_train_modified.drop("workload",axis=1)
        train_y= df_train_modified[["workload"]]
        test_x=df_test_modified.drop("workload",axis=1)
        test_y= df_test_modified[["workload"]]
